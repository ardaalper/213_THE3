...
class MultiGraph
{
    ...
    ///////////////////////BENİMHELPERLERİM___:)___////////////////////
    int vertexIndex(const std::string& vertexName, const std::vector<GraphVertex>& vertexList) const;
    int edgeIndex(const std::vector<GraphEdge>& edges, int endVertexIndex) const;
    int MaxDepthHelper(const std::string& vertexName,const std::string& edgeName,std::vector<bool>& gittik) const;
